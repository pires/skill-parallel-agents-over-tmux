...
**1. Spec first**: Write a design document in `docs/specs/` covering: problem,
...
spec: `Spec: \`docs/specs/feature-name.md\``. The first task in the phase should
include: "Read `docs/specs/feature-name.md` before starting any PX task."
